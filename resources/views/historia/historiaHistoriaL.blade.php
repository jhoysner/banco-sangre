                    ...
                    <tr>
                      ...
                      <td>
                        <div class="d-flex justify-content-around">
                            <a href="{{route('donante.show.historia',[$item->fecha, $item->donante_id])}}" class="btn btn-warning"><i class="fa fa-file" aria-hidden="true"></i></a> 
                        </div>
                      </td>
                    </tr>                        
